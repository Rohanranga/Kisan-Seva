                ...
                body: TabBarView(
                  children: [
                    ...
                    Container(
                      ...
                      child:   Center(child: Text('Usually its peak period of activity is first fortnight of July. During this period, it feeds on the cotyledons and young leaves, which results in stunted growth.  On heavy infestation, plant population is greatly affected and the yield loss is to the tune of 5 q/ha. Its infestation is more under high soil moisture conditions.')),
                    ...
                    Container(
                      ...
                      child: Center(child: Text('Blue beetle can be effectively controlled by spray of Quinalphos 25 EC @ 1.5 l/ha.') ),
                    )
